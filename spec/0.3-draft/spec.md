...
```json
{
  "@ocwg/node/ports/0.3": { "uri": "https://spec.canvasprotocol.org/0.3/ext.json#node-ports" },
...
[NOTE: `https://spec.canvasprotocol.org` points to `https://raw.githubusercontent.com/ocwg/spec/refs/heads/main/spec/`]
